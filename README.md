...
The Active Governor (Experiment 2) was the most successful trial because it achieved a "Virtual Cooling" effect, balancing high-compute performance with strict hardware safety protocols. By dynamically orchestrating power profiles, the system maintained 96% of peak throughput (36.8 GFLOPS) while successfully capping the SoC at 70.47 degrees, which was approximately 3.6 degrees cooler than the unmanaged Mode 0 baseline. Most significantly, the Governor proved to be the most energy-efficient configuration, consuming only 61.3 Joules per matrix calculation—surpassing both the high-heat Mode 0 (67.2 J) and the high-latency Mode 2 (63.7). This success demonstrates that intelligent software-defined power management can effectively mitigate a 58% thermal velocity increase in fan-less environments without incurring the prohibitive 27% latency penalty found in constant low-power states.
